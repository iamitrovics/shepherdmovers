...
(function ($) {
  jQuery(document).ready(function () {
    ...
    $(".date-picker-input").attr("autocomplete", "off"); //scroll to anchored
    ...
    $('#blog-page [data-fancybox="gallery"]').fancybox(); //$('#top-cta .features-list .feature-box h3').matchHeight();
    ...
    $('.full-content a').attr("target", "_blank"); //modal
